...
class SocialSDKLoader {
  ...
  async loadFacebookSDK(config: SDKConfig['facebook']): Promise<void> {
    ...
    // Eğer zaten yüklenmeye başladıysa
...
// SDK durumu kontrolü için utility fonksiyon
